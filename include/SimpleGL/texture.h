...
namespace detail {
    ...
    struct GLTextureInterface<kind, traits::IfTex1D<kind>> {
        void write (const void* data, const GLTextureInfo<kind>& info, int x = 0) {
    ...
    struct GLTextureInterface<kind, traits::IfTex2D<kind>> {
        void write (const void* data, const GLTextureInfo<kind>& info, int x = 0, int y = 0) {
    ...
    struct GLTextureInterface<kind, traits::IfTex3D<kind>> {
        void write (const void* data, const GLTextureInfo<kind>& info, int x = 0, int y = 0, int z = 0) {
...
template <GLenum kind>
class TextureBuilder<kind, traits::IfTex1D<kind>> : private detail::TextureBuilderBase<TextureBuilder<kind>> {
public:
    TextureBuilder () : 
...
template <GLenum kind>
class TextureBuilder<kind, traits::IfTex2D<kind>> : private detail::TextureBuilderBase<TextureBuilder<kind>> {
public:
    TextureBuilder () : 
        detail::TextureBuilderBase<TextureBuilder<kind>>()
    {}
...
template <GLenum kind>
class TextureBuilder<kind, traits::IfTex3D<kind>> : private detail::TextureBuilderBase<TextureBuilder<kind>> {
public:
    TextureBuilder () : 
        detail::TextureBuilderBase<TextureBuilder<kind>>()
    {}
