...
int main () {
    ...
    std::cout << "sizeof(GLResourceArray<GL_FRAMEBUFFER>): " << sizeof(sgl::GLResourceArray<GL_FRAMEBUFFER>) << std::endl;
    ...
    std::cout << "traits::param_size<float[3]>::size: " << sgl::traits::param_size<float[3]>::size << std::endl;
}
